...
func TestPurgeTags(t *testing.T) {
	...
	t.Run("Keep a tag when part of the excluded filter", func(t *testing.T) {
		assert := assert.New(t)
		...
		deletedTags, err := purgeTags(testCtx, mockClient, defaultPoolSize, testLoginURL, testRepo, "0", "v.*", 0, 60, "v1-a")
