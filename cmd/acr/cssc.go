...
const (
	...
	Use the --filter-policy flag to specify the repository:tag where the filter exists. If no filter policy is provided, it is defaulted to continuouspatchpolicy:latest
