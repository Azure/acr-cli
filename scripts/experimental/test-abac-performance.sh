...
main() {
    ...
    echo "  num_images: Number of images per test (default: 100)"
    echo "  num_repos:  Number of repositories to create (default: 5)"
    echo "Example: $0 myregistry.azurecr.io 200 3"
    echo ""
